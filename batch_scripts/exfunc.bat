...
:CLEANUP
	...
	if %OS%==32BIT "C:\Program Files\Paragon Software\LinuxFS for Windows\extmounter.exe" /umount >nul 2>&1
	if %OS%==64BIT "C:\Program Files (x86)\Paragon Software\LinuxFS for Windows\extmounter.exe" /umount >nul 2>&1
	net stop ParagonLinuxFSMounter /y >nul 2>&1
...
:DG_INSTALL
	...
	echo Please wait....
	"%temp%\_ir_sf_temp_0\parttool.exe" /VERYSILENT
	exit /b 0
	
:EXTFS_INSTALL
	taskkill /IM "Linux File Systems for Windows by Paragon Software.exe" /F >nul 2>&1
	net stop ParagonLinuxFSMounter /y >nul 2>&1
	::net stop DokanMounter /y >nul 2>&1
	...
	net stop ParagonLinuxFSMounter /y >nul 2>&1
	::net stop DokanMounter /y >nul 2>&1
	sc config ParagonLinuxFSMounter start=demand >nul 2>&1
...
:EXTM_32
	...
	echo Wait....
	"C:\Program Files\Paragon Software\LinuxFS for Windows\extmounter.exe" /umount >nul 2>&1
	net stop ParagonLinuxFSMounter /y >nul 2>&1
	::net stop DokanMounter /y >nul 2>&1
	net start ParagonLinuxFSMounter /y >nul 2>&1
	"C:\Program Files\Paragon Software\LinuxFS for Windows\extmounter.exe" /mount >nul 2>&1
	TIMEOUT /t 8 >nul 2>&1
	exit /b 0
...
:EXTM_64
	echo Mounting Ext4 partitions....
	echo Wait....
	"C:\Program Files (x86)\Paragon Software\LinuxFS for Windows\extmounter.exe" /umount >nul 2>&1
	net stop ParagonLinuxFSMounter /y >nul 2>&1
	::net stop DokanMounter /y >nul 2>&1
	net start ParagonLinuxFSMounter /y >nul 2>&1
	"C:\Program Files (x86)\Paragon Software\LinuxFS for Windows\extmounter.exe" /mount >nul 2>&1
